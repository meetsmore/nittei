...
pub fn configure_routes(router: &mut Router) {
    // Create a calendar
    router.route("/calendar", post(create_calendar_controller));
    ...
    // List calendars
    router.route("/calendar", get(get_calendars::get_calendars_controller));
    ...
    router.route("/calendar/meta", get(get_calendars_by_meta_controller));

    // Get a specific calendar by uid
    router.route("/calendar/{calendar_id}", get(get_calendar_controller));
    ...
    router.route("/calendar/{calendar_id}", put(update_calendar_controller));
