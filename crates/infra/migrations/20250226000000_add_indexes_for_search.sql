...
-- Useful for getting the recurring events' exceptions for specific users
...
-- Useful for directly searching the exceptions of a recurring event, without worrying about the `original_start_time` or user
...
-- Useful for querying the most recent events for specific users
